...
import {RentalRequest,  statusTextMap, statusToTabKeyMap, GetRequestRentalMarketListResponse, RentalRequestStatus} from '@/app/accountrental/types/rental/myrelearrequestrentalinfoTypes';
