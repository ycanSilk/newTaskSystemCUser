...
import { ApplicationItem } from '../../../types/rental/requestRental/getApplyedRequestRentalInfoListTypes';
import { ReviewApplicationRequest, ReviewApplicationResponse } from '../../../types/rental/requestRental/reviewAppliedRequestRentalInfoTypes';
...
const MyApplicationsPage = () => {
  ...
  const fetchApplications = async () => {
    ...
    try {
      // 调用API获取数据
      const response = await fetch('/api/rental/requestRental/getApplyedRequestRentalInfoList?page=1&page_size=20&my=1');
